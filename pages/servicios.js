    ...
    <section className='block w-full box-border '>
      <div className='flex gap-10 flex-wrap justify-center 2xl:justify-start'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='escrituras publica' src={escrituras_publicas} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Escrituras Públicas</h2>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='transferencia vehiculares' src={transferencias_vehiculares} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Transferencia Vechiculares</h2>
          <p className='text-sm md:text-lg'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='asuntos no contenciosos' src={asuntos_no_contenciosos} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Asuntos no Contenciosos</h2>
          <p className='text-sm md:text-lg'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='autorización de viaje' src={autorizacion_viaje} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Autorización de Viaje</h2>
          <p className='text-sm md:text-lg'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='certificacion de actas' src={certificacion_actas} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Certificación de Actas</h2>
          <p className='text-sm md:text-lg'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='legalizacion' src={legalizacion} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Legalizaciones</h2>
          <p className='text-sm md:text-lg'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='protestos' src={protestos} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Protestos</h2>
          <p className='text-sm md:text-lg'>
        ...
        <div className='flex flex-col w-[calc(90%-2rem)] lg:w-[calc(50%-2rem)] 2xl:w-[calc(33.33%-2rem)] border-neutral-100 border-2 rounded-xl p-6 cursor-pointer justify-between'>
          <Image alt='cartas notariales' src={cartas_notariales} className="w-full rounded-[.2rem]" />
          <h2 className='text-lg md:text-2xl text-primary font-semibold py-3'>Cartas Notariales</h2>
          <p className='text-sm md:text-lg'>
